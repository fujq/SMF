...
namespace Microsoft.SilverlightMediaFramework.Core.Media
{
    ...
    public partial class PlaylistItem : ObservableObject
    {
        ...
        private string _selectedAudioTrackName;
        ...
        private bool _isMultipleAudioTracks;
        ...
        private PlaylistItem(PlaylistItem playlistItem)
        {
            ...
            SelectedAudioTrackName = playlistItem.SelectedAudioTrackName;
            ...
            IsMultipleAudioTracks = playlistItem.IsMultipleAudioTracks;
        ...
        /// <summary>
        /// Gets or sets the category of the playlist item.
        /// </summary>
        [Category("Common Properties")]
        [ScriptableMember]
        ...
        /// <summary>
        /// Gets or sets the divID of the playlist item.
        /// </summary>
        [Category("Common Properties")]
        [ScriptableMember]
        public string DivID
        ...
        [Category("Metadata")]
        [ScriptableMember]
        public string SelectedAudioTrackName
        {
            get { return _selectedAudioTrackName; }
            set
            {
                if (_selectedAudioTrackName != value)
                {
                    _selectedAudioTrackName = value;
                    NotifyPropertyChanged("SelectedAudioTrackName");
                }
            }
        }
        ...
        [Category("Metadata")]
        [ScriptableMember]
        public bool IsMultipleAudioTracks
        {
            get { return _isMultipleAudioTracks; }
            set
            {
                if (_isMultipleAudioTracks != value)
                {
                    _isMultipleAudioTracks = value;
                    NotifyPropertyChanged("IsMultipleAudioTracks");
                }
            }
        }
