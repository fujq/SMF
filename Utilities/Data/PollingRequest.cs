    ...
    public class PollingRequest : IDisposable
    {
        ...
        private void WebClient_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            ...
            if (e.Error == null)
            {
              ...
              //      HtmlPage.Window.Invoke("globalJSMethod", "e.Result " + e.Result);
            ...
            {
      //          HtmlPage.Window.Invoke("globalJSMethod", "e.Error " + e.Error.ToString());
        ...
        {
            Uri newUri = (uri.IsAbsoluteUri && !uri.AbsoluteUri.Contains("?")) || string.IsNullOrEmpty(uri.Query)
                       ? new Uri(string.Format("{0}?ignore={1}", uri, Guid.NewGuid()))
                       : new Uri(string.Format("{0}&ignore={1}", uri, Guid.NewGuid()));

        //    HtmlPage.Window.Invoke("globalJSMethod", "CacheBust " + newUri.AbsoluteUri);
            return newUri;
        }
